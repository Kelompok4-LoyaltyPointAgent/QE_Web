...
WebUI.click(findTestObject('Transaksi/Page_Hola Pulsa/div_Kelola Transaksi'))

WebUI.click(findTestObject('Transaksi/Page_Hola Pulsa/a_Package_bi bi-file-earmark-text file-button'))
